        ...
        <div className="container mx-auto relative z-10 text-center max-w-4xl">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
            ...
            <motion.p variants={fadeIn} className="text-lg md:text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
              Connect with your campus community through engaging events, workshops, and festivals.
              Your all-in-one portal for a vibrant college life.
            </motion.p>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12">
            <div className="max-w-2xl">
              <h2 className="text-3xl md:text-4xl font-bold mb-3 tracking-tight">Trending This Week</h2>
